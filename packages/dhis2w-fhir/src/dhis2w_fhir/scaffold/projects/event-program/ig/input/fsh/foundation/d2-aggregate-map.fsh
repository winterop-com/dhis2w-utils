...
* group[0].rule[1].source[0].condition = "url = 'http://example.org/fhir/examples/event-program/StructureDefinition/d2-period'"
...
* group[0].rule[3].source[0].condition = "url = 'http://example.org/fhir/examples/event-program/StructureDefinition/d2-attribute-option-combo'"
