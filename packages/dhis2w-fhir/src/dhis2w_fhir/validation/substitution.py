...
def substitute_build_aborting_text(text: str) -> str:
    ...
    consumed by one of the rewrites, and every `>` beside it is consumed by the symmetric one. A
    name carrying neither comparison in either spelling is returned byte-true.
    """
