    ...
    return (
        <p className="text-muted-foreground border-border rounded-lg border border-dashed px-2.5 py-2 text-xs">
            {scope.restricted && scope.registryTotal > 0
                ? `This form's organisation-unit assignment names no organisation unit this project publishes, so there is nothing to report from - the registry holds ${String(scope.registryTotal)}. DHIS2 refuses a capture outside the assignment with E1029.`
