        ...
        <section className="space-y-3">
            <div className="space-y-0.5">
                ...
                <p className="text-muted-foreground text-sm">
                    ...
                    looked up in this DHIS2 instance.
                </p>
            </div>
...
function ReceiptFacts({
    ...
    return (
        <div className="space-y-3 bg-card rounded-lg border p-4">
            <p className="text-sm">
                {summary === null
                    ? 'The submission as it arrived, not a view of what this DHIS2 instance now holds.'
                    : `Received ${formatInstant(summary.received_at)} - the submission as it arrived, not a view of what this DHIS2 instance now holds.`}
            </p>
            ...
            <dl className="grid gap-x-6 gap-y-3 text-sm sm:grid-cols-3">
                ...
                {seed !== null && (
                    <Fact
                        ...
                        value={
                            <>
                                Generated by test data, seed{' '}
                                <span className="machine-identifier">{seed}</span>
                            </>
                        }
                    />
                )}
                ...
                {summary === null && <Fact label="Response status" value={stored.status} mono />}
            </dl>
