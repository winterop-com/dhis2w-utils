...
version-neutral `dhis2w_core.fhir_core`; this plugin binds it to the v43
...
class _FhirPlugin(BaseModel):
    ...
    def register_cli(self, app: Any) -> None:
        ...
        from dhis2w_core.v43.plugins.fhir import cli as cli_module

        cli_module.register(app)

    def register_mcp(self, mcp: Any) -> None:
        """Register the `fhir_*` tools on the MCP server."""
        from dhis2w_core.v43.plugins.fhir import mcp as mcp_module
