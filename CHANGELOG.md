...
- **`d2w fhir`: ConceptMaps and `$translate`, unique attributes as identifiers, and terminals that say the state rather than the firehose** (2026-08-08).
    ...
    **[FHIR for DHIS2 people](../guides/fhir-101.md)** is the new primer behind the IG guide: the handful of FHIR resources this toolkit keeps using, named in DHIS2 terms, in about ten minutes.
