...
d2w fhir            FHIR IG generation (SUSHI/FSH + pre-built JSON, package dhis2w-fhir)
  ...
  validate              FHIR-safety of the instance's codes (sweep + two deep
                        ...
                        selection (scope: selection/instance). The terminal is a
                        status view: the summary with the selection split and
                        the code-coverage fraction, a rollup row per (severity,
