...
d2w fhir            FHIR IG generation (SUSHI/FSH, package dhis2w-fhir)
  ...
  generate foundation   DHIS2 identifier aliases + the D2Period / D2FormType extensions
  ...
  generate all          All six targets in one run
