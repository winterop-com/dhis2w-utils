...
| **security** | Read-only security posture: password policy and registration settings, account authority risk categorisation. GET-only against a tested allowlist; CLI-only until its MCP surface lands. |
...
*Author: Morten (netroms@gmail.com)*
