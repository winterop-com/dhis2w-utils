...
async def main() -> None:
    ...
    # `version=Dhis2.V43` pins the generated module; pass None for auto-detect via /api/system/info.
    async with Dhis2Client(base_url, auth=build_auth(), version=Dhis2.V43) as client:
